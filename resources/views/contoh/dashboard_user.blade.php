...
<h2 class="fw-bold mb-4" style="color:#6c4ee6;">Selamat datang di Dashboard User!</h2>
<div class="row g-4">
    <div class="col-md-4 col-lg-3">
        <div class="card dashboard-card text-center">
            <div class="card-body">
                <div class="dashboard-icon"><i class="fa fa-calendar-check"></i></div>
                <div class="dashboard-title">Reservasi Aktif</div>
    ...
    <div class="col-md-4 col-lg-3">
        <div class="card dashboard-card text-center">
            <div class="card-body">
                ...
                <div class="dashboard-title">Kamar Saya</div>
                <div class="dashboard-value">-</div>
            </div>
        </div>
    </div>
    <div class="col-md-4 col-lg-3">
        <div class="card dashboard-card text-center">
            <div class="card-body">
                <div class="dashboard-icon" style="background:linear-gradient(90deg,#22c55e 70%,#4f8cff 100%);"><i class="fa fa-bell-concierge"></i></div>
                <div class="dashboard-title">Layanan Aktif</div>
                <div class="dashboard-value">-</div>
            </div>
        </div>
    </div>
