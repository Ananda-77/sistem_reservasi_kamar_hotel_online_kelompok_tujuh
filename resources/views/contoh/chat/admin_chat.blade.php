...
<div class="chat-container mt-4 mb-4">
    <div class="chat-header">
        <i class="fa fa-user"></i> Chat dengan User: <b>{{ $user->name }}</b>
    </div>
    ...
    <form action="{{ route('chat.admin.send', $user->id) }}" method="POST" class="chat-input-area">
        @csrf
        <input type="text" name="message" class="chat-input" placeholder="Tulis balasan..." autocomplete="off" required>
